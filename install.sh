...
www-data ALL=(ALL) NOPASSWD: /bin/systemctl restart clamav-freshclam
www-data ALL=(ALL) NOPASSWD: /bin/systemctl status clamav-freshclam
www-data ALL=(ALL) NOPASSWD: /bin/systemctl is-active clamav-freshclam
www-data ALL=(ALL) NOPASSWD: /bin/systemctl start clamav-freshclam
www-data ALL=(ALL) NOPASSWD: /bin/systemctl stop clamav-freshclam
